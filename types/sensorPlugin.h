...
#ifndef sensorPlugin_1710384978_h
#define sensorPlugin_1710384978_h
...
extern "C" {
    ...
    * AnotherSimple.
    *
    * By default, this type is struct SensorReadingType
    * itself. However, if for some reason this choice is not practical for your
    * system (e.g. if sizeof(struct SensorReadingType)
    * is very large), you may redefine this typedef in terms of another type of
    * your choosing. HOWEVER, if you define the KeyHolder type to be something
    * other than struct AnotherSimple, the
    * following restriction applies: the key of struct
    * SensorReadingType must consist of a
    * single field of your redefined KeyHolder type and that field must be the
    * first field in struct SensorReadingType.
    */
    typedef  class SensorReadingType SensorReadingTypeKeyHolder;

    #define SensorReadingTypePlugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
    #define SensorReadingTypePlugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
    #define SensorReadingTypePlugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

    #define SensorReadingTypePlugin_get_key PRESTypePluginDefaultEndpointData_getKey 
    #define SensorReadingTypePlugin_return_key PRESTypePluginDefaultEndpointData_returnKey

    #define SensorReadingTypePlugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
    #define SensorReadingTypePlugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

    /* --------------------------------------------------------------------------------------
    Support functions:
    * -------------------------------------------------------------------------------------- */

    NDDSUSERDllExport extern SensorReadingType*
    ...
    SensorReadingTypePluginSupport_copy_data(
        SensorReadingType *out,
        const SensorReadingType *in);
    ...
    * -------------------------------------------------------------------------------------- */
    ...
    SensorReadingTypePlugin_key_to_instance(
        PRESTypePluginEndpointData endpoint_data,
        SensorReadingType *instance, 
        const SensorReadingTypeKeyHolder *key);
    ...
    SensorReadingTypePlugin_new(void);

    NDDSUSERDllExport extern void
    SensorReadingTypePlugin_delete(struct PRESTypePlugin *);
...
#endif /* sensorPlugin_1710384978_h */
